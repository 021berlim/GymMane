...
|---|---|
| Android 7.0+ | 已支持 |
| Wear OS 3+ | 已支持，包含在同一个 APK 中 |
| iOS 15+ | 测试版，可在 [Actions](https://github.com/InlitX/GymMane/actions/workflows/build-ios.yml) 下载未签名的 IPA |
| 桌面端 | 计划中 |
