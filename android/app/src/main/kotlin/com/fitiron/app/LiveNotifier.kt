...
object LiveNotifier {
    ...
    private const val ACTION = "com.fitiron.app.LIVE_ACTION"
    ...
    private fun repost() {
        ...
        b.setSmallIcon(R.drawable.ic_stat_gymmane)
            ...
            .setCategory(if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) Notification.CATEGORY_WORKOUT else "workout")
