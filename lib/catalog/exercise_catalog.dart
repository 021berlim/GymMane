...
const List<Exercise> kExercises = [
  ...
  Exercise(
    ...
    primary: 'cardio',
    secondary: ['abdomen', 'shoulders', 'quads'],
    equipment: 'Bodyweight',
    difficulty: 'Beginner',
  ...
  Exercise(
    ...
    primary: 'warmup',
    secondary: ['shoulders', 'quads', 'hamstrings'],
    equipment: 'Bodyweight',
    difficulty: 'Beginner',
    art: '',
    steps: [
      'Perform light arm circles, leg swings, and torso twists to increase body temperature.',
      'Keep movement smooth and controlled without forcing any joint past comfort.',
      'Continue for 2 to 3 minutes before beginning heavier resistance training.',
    ],
  ),
  Exercise(
    id: 'wrm0002',
    ...
    art: '',
    steps: [
      'Stand tall and extend one leg forward with heel on the ground and toes pointed up.',
      'Hinge slightly at the hips while keeping back flat until a stretch is felt in the hamstrings.',
      'Hold gently for 20 to 30 seconds, breathing deeply, then switch legs.',
    ],
  ),
  Exercise(
    id: 'wrm0003',
    ...
    art: '',
    steps: [
      'Clasp your hands behind your lower back and straighten your arms.',
      'Gently lift your chest up and pull shoulders back to feel a stretch across the chest.',
      'Hold position comfortably for 20 seconds while maintaining relaxed breathing.',
    ],
  ),
  Exercise(
    id: 'wrm0004',
    ...
    steps: [
      ...
      'Inhale as you arch your back downwards, lifting head and tailbone toward ceiling.',
      'Exhale as you round your spine upwards toward ceiling, tucking chin to chest.',
    ],
  ),
  Exercise(
    id: 'wrm0005',
    ...
    art: '',
    steps: [
      'Kneel on one knee with opposite foot forward at a ninety degree angle.',
      'Shift hips forward while keeping torso upright until a stretch is felt in the front hip.',
      'Hold for 20 to 30 seconds on each side before switching legs.',
    ],
  ),
  Exercise(
    id: 'wrm0006',
    ...
    primary: 'warmup',
    secondary: ['back', 'quads', 'hamstrings', 'glutes'],
    equipment: 'Other',
    difficulty: 'Beginner',
    art: '',
    steps: [
      'Place foam roller under target muscle group and support bodyweight with hands and feet.',
      'Slowly roll back and forth over tight areas for 30 to 60 seconds.',
      'Pause over tender spots to help release muscular tension.',
    ],
  ),
];
...
const List<String> kFilterMuscles = [
  'warmup', 'cardio', 'chest', 'back', 'shoulders', 'biceps', 'triceps', 'abdomen', 'quads', 'glutes', 'hamstrings', 'calves'
];
...
const List<String> kFilterEquipment = [
  'Bodyweight', 'Dumbbell', 'Barbell', 'Machine', 'Cable', 'Band', 'Kettlebell', 'Weighted'
];
