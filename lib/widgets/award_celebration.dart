      ...
      if (boundary != null) {
        ...
        if (data != null) {
          ...
          final ok = await saveImageToGallery(
            ...
            'fitiron-${widget.id.name}-$stamp.png',
          );
                      ...
                      children: [
                        ...
                        _fade(
                          ...
                          Text(
                            awardName(widget.id),
                            textAlign: TextAlign.center,
                            style: AppTheme.d(32, weight: FontWeight.w800, color: gc.text),
                          ),
                        ),
                        const SizedBox(height: 12),
                        _fade(
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                children: [
                  Text('FIT//IRON',
                      style: AppTheme.d(18, weight: FontWeight.w800, color: gc.text, letterSpacing: 2)),
                  const Spacer(),
                  ...
                  Text(awardName(id),
                      textAlign: TextAlign.center,
                      style: AppTheme.d(30, weight: FontWeight.w800, color: gc.text)),
            ...
            Column(
              ...
              children: [
                ...
                Text('@${fit.profileHandle}',
                    style: AppTheme.s(12.5, weight: FontWeight.w500, color: gc.textSecondary)),
              ],
            ),
          ],
        ),
