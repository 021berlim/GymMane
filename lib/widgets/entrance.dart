...
/// Transição escalonada para cartões de resumo ou seções de tela:
/// atraso base de 40ms + 70ms por índice, tempo de movimento de 560ms,
/// translação vertical de 22px, escala 0.97 -> 1.0 e fade com Curves.easeOutCubic.
