// Origem: lib/widgets/muscle_radar.dart (~L100-105) e lib/widgets/rolling_text.dart (~L1-160)
// Animação 8: Transições em nível de widget (AnimatedSwitcher 220ms, RollingText 420ms e RollIn 1150ms)
// Parâmetros originais específicos desacoplados:
// - Desacoplado de `t.muscle` e dados de treino do GymMane.
// - Criados `SubtleTextSwitcher`, `RollingText` e `RollInCounter`.
...
/// Widget com efeito de roleta (odômetro individual de dígitos) para números e textos em contagem.
...
/// Contador inicial progressivo (1150ms) usando interpolação e rodas de dígitos.
